...
st.title("Análise de Crédito — Rede Neural COM Camada Oculta (1 camada, 5 neurônios)")
...
# Contagem de parâmetros (pesos + vieses)
...
# Inputs do usuário — usa os nomes das colunas da base
default_inputs = {
