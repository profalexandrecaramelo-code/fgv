...
# ------------------------------
# Simular dados fictícios atualizados
# ------------------------------
def gerar_dados_ficticios(n=500):
    ...
    data = pd.DataFrame({
        ...
        'num_manutencoes': np.random.randint(1, 6, size=n),  # De 1 até 5
        'num_colaboradores_unidade': np.random.randint(1, 31, size=n),  # De 1 até 30
...
def main():
    ...
    st.write("Modelo treinado em dados fictícios atualizados.")
    ...
    num_manutencoes = st.slider("Número de manutenções", 1, 5, 1)
