...
if train_file:
    ...
    if st.button("🚀 Treinar Modelo"):
        ...
        if predict_file:
            ...
            df_to_predict = preprocessar_dados(df_new, is_labeled=False)
            preds_proba = model.predict_proba(df_to_predict)[:, 1]
            df_new['Risco_de_Churn'] = preds_proba
            df_result = df_new.sort_values(by='Risco_de_Churn', ascending=False)
